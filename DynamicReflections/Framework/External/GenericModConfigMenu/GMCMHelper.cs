...
namespace DynamicReflections.Framework.External.GenericModConfigMenu
{
    internal class GMCMHelper
    {
        ...
        public static void Register(IGenericModConfigMenuApi configApi, DynamicReflections dynamicReflections, bool unregisterOld = false, bool loadLocationNames = false)
        {
            ...
            configApi.AddBoolOption(ModManifest, () => DynamicReflections.modConfig.AreMapReflectionsEnabled, value => DynamicReflections.modConfig.AreMapReflectionsEnabled = value, () => Helper.Translation.Get("config.general_settings.map_reflections"));
            configApi.AddBoolOption(ModManifest, () => DynamicReflections.modConfig.ShouldUsePresetMapReflections, value => DynamicReflections.modConfig.ShouldUsePresetMapReflections = value, () => Helper.Translation.Get("config.general_settings.use_preset_map_reflections"));
            ...
            configApi.AddSectionTitle(ModManifest, () => Helper.Translation.Get("config.general_settings.reflection_offsets"));
            ...
            configApi.AddNumberOption(ModManifest, () => DynamicReflections.modConfig.LocalWaterReflectionSettings[_currentLocation].CompanionReflectionOffset.X, value => DynamicReflections.modConfig.LocalWaterReflectionSettings[_currentLocation].CompanionReflectionOffset = new Vector2(value, DynamicReflections.modConfig.LocalWaterReflectionSettings[_currentLocation].CompanionReflectionOffset.Y), () => Helper.Translation.Get("config.water_settings.offset.x"), interval: 0.1f);
            configApi.AddNumberOption(ModManifest, () => DynamicReflections.modConfig.LocalWaterReflectionSettings[_currentLocation].CompanionReflectionOffset.Y, value => DynamicReflections.modConfig.LocalWaterReflectionSettings[_currentLocation].CompanionReflectionOffset = new Vector2(DynamicReflections.modConfig.LocalWaterReflectionSettings[_currentLocation].CompanionReflectionOffset.X, value), () => Helper.Translation.Get("config.water_settings.offset.y"), interval: 0.1f);
            ...
            configApi.AddSectionTitle(ModManifest, () => Helper.Translation.Get("config.general_settings.animals_offsets"));
            configApi.AddNumberOption(ModManifest, () => DynamicReflections.modConfig.LocalPuddleReflectionSettings[_currentLocation].CompanionReflectionOffset.X, value => DynamicReflections.modConfig.LocalPuddleReflectionSettings[_currentLocation].CompanionReflectionOffset = new Vector2(value, DynamicReflections.modConfig.LocalPuddleReflectionSettings[_currentLocation].CompanionReflectionOffset.Y), () => Helper.Translation.Get("config.water_settings.offset.x"), interval: 0.1f);
            configApi.AddNumberOption(ModManifest, () => DynamicReflections.modConfig.LocalPuddleReflectionSettings[_currentLocation].CompanionReflectionOffset.Y, value => DynamicReflections.modConfig.LocalPuddleReflectionSettings[_currentLocation].CompanionReflectionOffset = new Vector2(DynamicReflections.modConfig.LocalPuddleReflectionSettings[_currentLocation].CompanionReflectionOffset.X, value), () => Helper.Translation.Get("config.water_settings.offset.y"), interval: 0.1f);
